...
const initialState = window.__PRELOADED_STATE__; // eslint-disable-line
...
if (process.env.NODE_ENV !== 'production') {
  ...
  if (!appElement || !appElement.firstChild || !appElement.firstChild.attributes) {
    const message = `Server-side React render was discarded.
